...
export default function PngToJpgPage() {
    ...
    const processFiles = (files) => {
        ...
        if (validFiles.length > 0) {
            ...
            setError("");
            setConvertedFiles([]); // Reset converted files on new add
        } else {
            setError("Please select valid PNG images.");
        }
    };
        ...
        return new Promise((resolve, reject) => {
            ...
            reader.onload = (event) => {
                ...
                img.onload = () => {
                    ...
                    // JPG does not support transparency, so fill with white background
                        ...
                        <div className="space-y-2">
                            <p className="text-lg font-medium text-gray-700">
                                {selectedFiles.length > 0
                                    ...
                                    : "Drop your PNG images here or click to browse"}
                            </p>
                ...
                {selectedFiles.length > 0 && convertedFiles.length === 0 && (
                    <div className="text-center mb-6">
                        <button
                            ...
                            className="px-8 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center mx-auto shadow-md"
                        >
                            {isConverting ? (
                                <>
                            ...
                            {convertedFiles.map((file, index) => (
                                <div key={index} className="border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow flex items-center space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-gray-500">JPG Image</p>
                                    </div>
                                    <button
